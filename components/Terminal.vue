<template>
  <div class="w-full max-w-sm text-white transition-all duration-500 bg-gray-900 rounded-lg shadow-lg max-w-96 dark:hover:bg-shamrock-900 dark:bg-shamrock-800 hover:bg-gray-800">
    ...
    <div class="p-2 font-mono text-gray-300">
      <pre>
$ psql
