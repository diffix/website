  ...
  <div id="mc_embed_signup" class="px-8 py-10 bg-gray-50 dark:bg-gray-800">
    ...
    >
      <div id="mc_embed_signup_scroll">
        ...
        >
          <div class="mt-4 text-sm content__gdpr">
            <p class="text-sm">
        ...
        <div class="p-2 mt-4 -mx-2 rounded-lg mc-field-group group hover:bg-gray-100 dark:hover:bg-gray-700 focus-within:bg-gray-100 dark:focus-within:bg-gray-700">
        ...
        <div>
          ...
          <div class="mt-2 text-xs text-gray-500 content__gdprLegal">
            <p>
