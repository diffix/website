    ...
    <div class="lg:mt-12 lg:ml-80">
      <div class="mx-auto lg:max-w-2xl space-y-6 lg:space-y-12 pt-12 lg:pt-0">
        <FAQItem {addToToc} question="What is Diffix?">
          Diffix is a bundled set of mechanisms for anonymizing structured data. It was jointly developed by Aircloak GmbH and the Max
          Planck Institute for Software Systems. Diffix' exploits mechansims that have been in use
          by national statistics offices for decades: 
          <b>aggregation</b>, <b>generalization</b>, <b>noise</b>, <b>suppression</b>, and <b>swapping</b>.
          It automatically applies these mechanisms as
          needed on a query-by-query basis to minimize noise while ensuring strong anonymity.
          <Link href="/blog/diffix-elm-automates-what-statistics-offices-have-been-doing-for-decades">Here</Link> is a brief overview. 
        </FAQItem>
        ...
        <FAQItem {addToToc} question="Where can I learn about Diffix Elm?">
          A good overview of Diffix Elm can be found <Link href="/blog/diffix-elm-automates-what-statistics-offices-have-been-doing-for-decades">here</Link>.
        ...
        <FAQItem {addToToc} question="What about data quality?">
          ...
          The data quality of Diffix is similar to data released by national
          statistics offices (e.g. census data), and usually far exceeds that of k-anonymity and Differential Privacy. Diffix
        ...
        <FAQItem {addToToc} question="Why are there both desktop and PostgreSQL extension releases?">
          ...
          Desktop satisfies this use case. At the other extreme, someone may wish to stream data summaries of dynamic
          data over millions of users into an SQL-based dashboard application. For this the Diffix for PostgreSQL is
          appropriate.
        </FAQItem>
