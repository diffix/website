...
<div class="font-semibold">
  {#if currentPage}
    <div
      class="transition-colors duration-500 shadow-md px-4 py-4 h-full border-b-4 border-pink-500 md:border-shamrock-600 md:bg-shamrock-400 bg-pink-400 text-white"
    >
      <slot />
    </div>
  {:else}
